...
export const CustomCursor: React.FC = () => {
  ...
  let cursorClass = "w-4 h-4 bg-white rounded-full";
  ...
  if (cursorMode === 'hover') {
    ...
    cursorClass = "w-16 h-16 bg-white/90 flex items-center justify-center rounded-full text-[10px] uppercase font-mono tracking-widest text-black font-bold text-center select-none shadow-lg shadow-white/20";
    outerClass = "w-20 h-20 border border-white/50 rounded-full scale-105 opacity-50";
  } else if (cursorMode === 'text') {
    cursorClass = "w-1 h-6 bg-white rounded-sm";
    outerClass = "w-4 h-8 border border-neutral-300 dark:border-neutral-700 rounded-sm scale-100";
  } else if (cursorMode === 'drag') {
    cursorClass = "w-14 h-14 bg-neutral-900/90 dark:bg-white/90 flex items-center justify-center rounded-full text-[10px] uppercase font-mono tracking-widest text-black dark:text-black font-bold text-center select-none shadow-lg";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {cursorMode === 'drag' && (
          <span className="text-black dark:text-black text-[10px] font-mono tracking-wider font-bold select-none">
            DRAG
          </span>
        )}
      </div>
